import { a as volumen, i as useMercado, n as nombreVisible, o as useSesion, r as probabilidad, t as haceTexto } from "./useMercado-CbPu3ooe.js";
...
function Hero({ mercado }) {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: nombres.length > 0 && /* @__PURE__ */ jsx("p", {
...
function MiniGrafico({ historial }) {
	...
	if (historial.length === 0) return /* @__PURE__ */ jsx("div", {
...
function FilaPregunta({ pregunta, onApostar, onRetirar, bloqueado }) {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(MiniGrafico, { historial: pregunta.historial }),
			cerrada ? /* @__PURE__ */ jsxs("p", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					children: /* @__PURE__ */ jsx("span", { children: "NO" })
				}), /* @__PURE__ */ jsx("button", {
					...
					children: /* @__PURE__ */ jsx("span", { children: "SÍ" })
				})]
			}), apostado > 0 && /* @__PURE__ */ jsxs("button", {
				onClick: onRetirar,
...
function MarketPage() {
	...
	const [vistaAdmin, setVistaAdmin] = useState("preguntas");
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("header", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("button", {
					...
					children: [
						...
						usuario.esAdmin && /* @__PURE__ */ jsx("button", {
						...
						/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Moneda, {}), /* @__PURE__ */ jsx("span", {
			...
			children: [
				mercado.pausado && /* @__PURE__ */ jsx("p", {
				...
				(vista === "feed" || vista === "archivadas") && /* @__PURE__ */ jsxs(Fragment, { children: [
					/* @__PURE__ */ jsx(Hero, { mercado }),
					/* @__PURE__ */ jsx("ul", {
						className: "mt-4 space-y-2 text-center text-[14px] font-normal leading-relaxed text-sutil",
						children: mercado.leerApuestas().map((a) => /* @__PURE__ */ jsxs("li", {
				...
				vista === "admin" && usuario.esAdmin && /* @__PURE__ */ jsxs("section", {
					className: "pt-6",
					children: [
						/* @__PURE__ */ jsx("div", {
						...
						vistaAdmin === "preguntas" && mercado.leerPreguntas({ estado: "todas" }).filter((p) => !p.archivada).map((p) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("select", {
									...
									children: asignaturas.map((a) => /* @__PURE__ */ jsx("option", {
										value: a.id,
										children: a.nombre
									}, a.id))
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										p.resultado === null ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("button", {
						...
						vistaAdmin === "archivado" && /* @__PURE__ */ jsxs(Fragment, { children: [mercado.leerPreguntas({ estado: "archivadas" }).map((p) => /* @__PURE__ */ jsxs("div", {
						...
						}, p.id)), mercado.leerPreguntas({ estado: "archivadas" }).length === 0 && /* @__PURE__ */ jsx("p", {
							className: `mt-5 ${mono} text-sutil`,
							children: "archivo vacío"
						})] }),
						vistaAdmin === "usuarios" && mercado.leerAlumnos().map((a) => /* @__PURE__ */ jsxs("div", {
						...
						vistaAdmin === "asignaturas" && /* @__PURE__ */ jsxs(Fragment, { children: [asignaturas.map((a) => /* @__PURE__ */ jsxs("div", {
