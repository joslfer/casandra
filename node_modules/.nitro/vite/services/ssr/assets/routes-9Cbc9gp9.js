import { i as useMercado, o as useSesion, r as probabilidad, t as haceTexto } from "./useMercado-CgAkKORp.js";
import { useCallback, useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/hooks/useHaptic.ts
/**
...
//#endregion
//#region src/screens/MarketPage.tsx
function Moneda({ className = "" }) {
	return /* @__PURE__ */ jsx("span", { className: `h-3.5 w-3.5 rounded-full bg-moneda ${className}` });
}
...
function EscalaPuntos({ si, no, misSi, misNo }) {
	if (si + no === 0) return /* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [Array.from({ length: otrosNo }).map((_, i) => /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-rojo" }, `no-o-${i}`)), Array.from({ length: misNo }).map((_, i) => /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-moneda" }, `no-m-${i}`))]
		}), /* @__PURE__ */ jsxs("div", {
			className: "flex flex-row-reverse flex-wrap gap-1",
			children: [Array.from({ length: otrosSi }).map((_, i) => /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-verde" }, `si-o-${i}`)), Array.from({ length: misSi }).map((_, i) => /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-moneda" }, `si-m-${i}`))]
		})]
	});
}
function FilaPregunta({ pregunta, onApostar, bloqueado, sinTokens, ocultarBorde }) {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(EscalaPuntos, {
				si: pregunta.poolSi,
				no: pregunta.poolNo,
				misSi: pregunta.misSi,
				misNo: pregunta.misNo
			}),
			cerrada ? /* @__PURE__ */ jsxs("p", {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "NO" }), pregunta.misNo > 0 && /* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "SÍ" }), pregunta.misSi > 0 && /* @__PURE__ */ jsxs("span", {
						className: "font-mono text-[12px] tabular-nums",
...
function Asignaturas({ asignaturas, asigId, setAsigActiva }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: asignaturas.map((a) => /* @__PURE__ */ jsx("button", {
...
function MarketPage() {
	...
	const [rankingDisplay, setRankingDisplay] = useState([]);
	const [actividadDisplay, setActividadDisplay] = useState([]);
	const [preguntasDisplay, setPreguntasDisplay] = useState([]);
	useEffect(() => {
	...
	if (cargando) return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-lienzo" });
	if (!usuario) return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			/* @__PURE__ */ jsx("header", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: [usuario.esAdmin && /* @__PURE__ */ jsx(Link, {
							to: "/admin",
							className: mono,
							children: "Admin"
						}), /* @__PURE__ */ jsx(Link, {
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								style: fuenteApple,
								children: rankingDisplay.slice(0, 4).map((r, i) => /* @__PURE__ */ jsxs("li", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: [
											r.tokens,
											" ",
											/* @__PURE__ */ jsx(Moneda, { className: "h-2.5 w-2.5" })
										]
									})]
								}, i))
							})]
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								style: fuenteApple,
								children: actividadDisplay.slice(0, 4).map((a) => /* @__PURE__ */ jsxs("li", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("span", {
												...
												children: [
													a.tokens,
													" ",
													/* @__PURE__ */ jsx(Moneda, { className: "h-2 w-2" })
												]
											})
										]
									}), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsx(Asignaturas, {
						asignaturas,
						asigId,
						setAsigActiva
					}),
					abiertas.map((p, index) => /* @__PURE__ */ jsx(FilaPregunta, {
						pregunta: p,
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: "Archivadas" }), /* @__PURE__ */ jsx("svg", {
					...
					mostrarArchivadas && /* @__PURE__ */ jsx("div", {
						className: "mt-4 flex flex-col",
						children: archivadas.map((p, index) => /* @__PURE__ */ jsx(FilaPregunta, {
							pregunta: p,
							bloqueado: mercado.pausado,
							sinTokens: mercado.saldo < 1,
							ocultarBorde: index === abiertas.length - 1,
			...
			modalAbierto && /* @__PURE__ */ jsx(ModalNuevaPregunta, {
				asignaturas,
				asigInicial: asigId,
