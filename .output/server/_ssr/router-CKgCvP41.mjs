...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CKgCvP41.js
var router_CKgCvP41_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DUyGwoWr.css";
...
var Route$3 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Mercado de predicción académico: apuesta tokens a si una pregunta entra en el examen."
			},
			{
				property: "og:title",
				content: "Casandra"
			},
			{
				...
				content: "Mercado de predicción académico entre alumnos."
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter$2 = () => import("./routes-9Cbc9gp9.mjs");
...
var $$splitComponentImporter$1 = () => import("./admin-BgNrTQu3.mjs");
var Route$1 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./profile-BxPjYK8I.mjs");
...
//#endregion
export { getRouter, router_CKgCvP41_exports as t };
