...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-D5my6HCG.js
var server_D5my6HCG_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DIohP52l.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CKgCvP41.mjs").then((n) => n.t),
		import("./start-FIwqcrOZ.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_D5my6HCG_exports as t };
