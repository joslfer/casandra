...
import { a as useSesion, i as useMercado, n as nombreVisible, o as volumen, r as probabilidad } from "./useMercado-CgAkKORp.mjs";
import { h as Link } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-BgNrTQu3.js
...
function AdminPage() {
	...
	if (!usuario.esAdmin) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-screen flex-col items-center justify-center bg-lienzo px-6 text-center",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "text-2xl font-semibold tracking-tight",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 max-w-xs text-[14px] leading-relaxed text-sutil",
				children: "Esta sección es solo para administradores."
			}),
